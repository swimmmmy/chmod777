...
현대 군은 대부분의 무기체계를 PNT 정보에 의존해 운용한다. 그중에서도 Timing(T)은 Position과 Navigation을 계산하는 기준이 되기 때문에, 아주 작은 시간 오차도 전체 PNT 정확도에 영향을 줄 수 있다.
